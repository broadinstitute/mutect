...
public class CallStatsGenerator {
    ...
    private static final String[] COMPLETE_CALL_STATS_HEADER =
            new String[]{
                ...
                "init_t_lod","t_lod_fstar","t_lod_fstar_forward", "t_lod_fstar_reverse", "tumor_f", "tumor_f_lb", "contaminant_fraction","contaminant_lod","minimum_tumor_f", "t_q20_count", "t_ref_count","t_alt_count","t_ref_sum","t_alt_sum","t_ins_count","t_del_count",
                "normal_best_gt","init_n_lod","n_lod_fstar","normal_f",
                "normal_artifact_lod_tf", "normal_artifact_lod_low_tf", "normal_artifact_lod_nf",
